...
class ContinualLearningWrapper(gym.Wrapper):
    ...
    def __init__(self, env, task_name, max_iterations=3000, level_switch=200, shift_range=[0, 2], seed=None, reward_scale=20.0, episode_cap=500, logging_callback=None, num_levels=15, no_noise=False):
        super().__init__(env)
...
class DebugTopologyPolicy(ActorCriticPolicy):
    ...
    def __init__(self, observation_space, action_space, lr_schedule, topology_type='fully_connected', hidden_size=64, num_layers=3, config=None, *args, **kwargs):
        ...
        try:
            ...
            if hasattr(topology_network, 'node_states'):
                ...
                if hasattr(topology_network, 'generate'):
                    ...
                    hidden_size = getattr(topology_network, 'size', 64)
...
def create_continual_learning_run_name(config, topology_type, task_name, seed, model=None, shift_range=None, no_noise=False):
    ...
    Example: SW_L3_S64_P12345_CP_seed42_L15_I3000_LS200_N02
    """
    # Topology abbreviation
    topology_abbrev = {
        'small_world': 'SW',
...
def make_env(env_name, seed=None, continual_learning=False, max_iterations=3000, level_switch=200, shift_range=[0, 2], reward_scale=20.0, episode_cap=500, logging_callback=None, num_levels=15, no_noise=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_levels", type=int, default=15, 
                       help="Number of distribution shift levels (default: 15, each level = 200 iterations × 1000 env steps)")
