...
def make_env(env_name, seed=None, continual_learning=False, max_iterations=6000, level_switch=400, shift_range=[0, 2], reward_scale=20.0, episode_cap=500, logging_callback=None, num_levels=15, no_noise=False):
