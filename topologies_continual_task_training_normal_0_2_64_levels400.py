...
class ContinualLearningWrapper(gym.Wrapper):
    ...
    def __init__(self, env, task_name, max_iterations=6000, level_switch=400, shift_range=[0, 2], seed=None, reward_scale=20.0, episode_cap=400, logging_callback=None, num_levels=15, no_noise=False):
        super().__init__(env)
...
def create_continual_learning_run_name(config, topology_type, task_name, seed, model=None, shift_range=None, no_noise=False):
    ...
    Example: SW_L3_S64_P12345_CP_seed42_L15_I6000_LS400_N02
    """
    # Topology abbreviation
    topology_abbrev = {
        'small_world': 'SW',
...
def make_env(env_name, seed=None, continual_learning=False, max_iterations=6000, level_switch=400, shift_range=[0, 2], reward_scale=20.0, episode_cap=400, logging_callback=None, num_levels=15, no_noise=False):
...
def continual_learning_training(config, task_name, topology_type, seed, use_wandb=True, enable_phase3=False, device=None, no_noise=False):
    ...
    print(f"   Each iteration will run ~1000 environment steps (2 episodes × 400 steps)")
