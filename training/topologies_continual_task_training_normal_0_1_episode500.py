...
class ContinualLearningWrapper(gym.Wrapper):
    ...
    def __init__(self, env, task_name, max_iterations=3000, level_switch=200, shift_range=[0, 1], seed=None, reward_scale=20.0, episode_cap=500, logging_callback=None, num_levels=15, no_noise=False):
        super().__init__(env)
...
def make_env(env_name, seed=None, continual_learning=False, max_iterations=3000, level_switch=200, shift_range=[0, 1], reward_scale=20.0, episode_cap=500, logging_callback=None, num_levels=15, no_noise=False):
